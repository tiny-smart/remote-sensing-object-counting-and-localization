...
import math
def delta(epoch):
    return 1-1/(1+math.exp(-0.03*(epoch-100)))
...
def get_args_parser():
    ...
    parser.add_argument('--data_path', default="/data/ctf/workfile/CORN_DATA/DATA/", type=str)
    ...
    # loss scheduler
    parser.add_argument('--sch_type', default=0, type=int,help='schtype,0=StepLR,1=coslr')
    
    # data_argument
    parser.add_argument('--order', default=4132, type=int, help='order to process data')
    parser.add_argument('--gauss', default=1, type=int,help='init gauss noise:turn this to 1')
    parser.add_argument('--clahe', default=1, type=int,help='init clahe noise:turn this to 1')
    parser.add_argument('--saltpepper', default=1, type=int,help='init saltpepper noise:turn this to 1')
    parser.add_argument('--fourier', default=1, type=int, help='init fourier noise:turn this to 1')
