...
def get_args_parser():
    ...
    parser.add_argument('--resume', default='./outputs/CARPK/pet_model/best_checkpoint.pth', help='resume from checkpoint')##############
    ...
    # data_argument
    parser.add_argument('--order', default=1324, type=int, help='order to process data')
