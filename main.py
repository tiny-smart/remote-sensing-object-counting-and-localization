...
def get_args_parser():
    ...
    # parser.add_argument('--resume', default=r"/home/rscount/lhx/Remote-Sensing-Target-Localization/outputs/Car/pet_model_Car/best_checkpoint.pth", help='resume from checkpoint')
...
def main(args):
    ...
    # resume
    best_mae, best_F1, best_abs, best_epoch = 1e8,1e-8, 1e8,0
    if args.resume:
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch % args.eval_freq == 0:
            ...
            mae, mse, F1, abs= test(args, output_dir / 'checkpoint.pth')
            t2 = time.time()

            # output results

            if mae < best_mae and F1 > best_F1:
                best_epoch = epoch
                best_mae = mae
                best_F1 = F1
                best_abs = abs
            print("\n==========================")
            print("\nepoch:", epoch, "mae:", mae, "mse:", mse, "\n\nbest mae:", best_mae,"best F1:", best_F1,"best abs:", best_abs, "best epoch:", best_epoch)
            print("==========================\n")
            if utils.is_main_process():
                with open(run_log_name, "a") as log_file:
                    log_file.write("\nepoch:{}, mae:{}, mse:{}, F1:{}, abs:{}, time{}, \n\nbest mae:{},best F1:{},best abs:{}, best epoch: {}\n\n".format(
                        epoch, mae, mse,F1, abs,t2 - t1, best_mae, best_F1, best_abs, best_epoch))
